...
class SmartTextEdit(SpellCheckEdit):
  ...
  def smart_quotes(self, cursor):
    ...
    if prev_char in [None, u" ", u"\t", u"(", u"[", u"{", u"<", u"\uFFFC", LEFT_APOST if char == QUOTE else LEFT_QUOTE, RIGHT_QUOTE if char == QUOTE else RIGHT_APOST]:
