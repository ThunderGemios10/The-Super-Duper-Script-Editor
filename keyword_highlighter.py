...
class KeywordHighlighter(QtGui.QSyntaxHighlighter):
  ...
  def highlightBlock(self, text):
    ...
    for keyword in self.keywords:
      ...
      #matches = [match for match in re.finditer(keyword.word, text, self.re_flags)]
      #matches = re.finditer(keyword.word, text, self.re_flags)
      #keyword.compiled.flags = self.re_flags
      ...
      for match in matches:
        ...
        #self.matches[line].append((keyword, match.start(), match.end()))
