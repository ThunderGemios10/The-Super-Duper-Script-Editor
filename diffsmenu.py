...
class DiffsMenu(QtGui.QDialog):
  ...
  def changedSelection(self, current, prev):
    ...
    to_diff = [
      ...
      (script1.translated,  script2.translated, self.ui.txtTranslated1, self.ui.txtTranslated2),
      (script1.original,    script2.original,   self.ui.txtOriginal1,   self.ui.txtOriginal2),
