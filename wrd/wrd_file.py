...
def main():
  ...
  wrds = glob.iglob("wip/wrds/*.wrd")
  pys  = glob.iglob("wip/wrds/*.py")
  # wrds = glob.iglob("wip/wrds/!e00*.wrd")
  ...
  # WrdFile("X:/Danganronpa/Danganronpa_BEST/umdimage/e01_004_135.lin/!e01_004_135.scp.py")
  return
