...
class AnagramFile():
  ...
  def pack(self, for_game = False):
    ...
    # Number of letters
    if is_translated:
      output += ConstBitStream(uintle = len(self.solution.translated), length = 16)
    else:
      output += ConstBitStream(uintle = len(self.solution.original), length = 16)
  ...
  #test_anagram = AnagramFile("umdimage/test.dat")
  #print test_anagram.solution.translated
  #print test_anagram.easy
  #print test_anagram.normal
  #print test_anagram.hard
  #test_anagram.solution_index = 254
  #test_anagram.extra_index    = 255
  #test_anagram.solution.translated = u"ＡＯＩＣＨＩＲＩＴＯＲＩ"
  #test_anagram.save("umdimage/test.dat")
