...
class Ui_FontGenWidget(object):
    def setupUi(self, FontGenWidget):
        ...
        self.chkTrace = QtGui.QCheckBox(self.groupBox_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.chkTrace.sizePolicy().hasHeightForWidth())
        self.chkTrace.setSizePolicy(sizePolicy)
        self.chkTrace.setText(QtGui.QApplication.translate("FontGenWidget", "Trace Outlines", None, QtGui.QApplication.UnicodeUTF8))
        self.chkTrace.setObjectName(_fromUtf8("chkTrace"))
        self.horizontalLayout_10.addWidget(self.chkTrace)
        ...
        self.spnPenSize = QtGui.QDoubleSpinBox(self.groupBox_2)
        self.spnPenSize.setEnabled(False)
        ...
        self.horizontalLayout_9.addWidget(self.spnPenSize)
        ...
        QtCore.QObject.connect(self.chkTrace, QtCore.SIGNAL(_fromUtf8("toggled(bool)")), self.spnPenSize.setEnabled)
        ...
        FontGenWidget.setTabOrder(self.spnYShift, self.chkTrace)
        FontGenWidget.setTabOrder(self.chkTrace, self.spnPenSize)
        FontGenWidget.setTabOrder(self.spnPenSize, self.chkBoundingBoxes)
