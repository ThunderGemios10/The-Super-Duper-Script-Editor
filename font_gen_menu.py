...
class FontGenMenu(QtGui.QDialog):
  ...
  def __generate_font__(self):
    ...
    if for_game:
      game_bmp  = os.path.join(common.editor_config.umdimage2_dir, "font.pak", "0000.bmp"  if gen_font1 else "0002.bmp")
      game_font = os.path.join(common.editor_config.umdimage2_dir, "font.pak", "0001.font" if gen_font1 else "0003.font")
      ...
      shutil.copy(font_bmp, game_bmp)
      shutil.copy(font_font, game_font)
